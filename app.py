...
# Initialize S3 client for Crypto Lake only if credentials are available
s3_client = None
if CRYPTO_LAKE_CONFIG['aws_access_key_id'] and CRYPTO_LAKE_CONFIG['aws_secret_access_key']:
    try:
